...
import { MenuIcon, LogOutIcon, TruckIcon, UtensilsCrossedIcon, BarChart3Icon, HistoryIcon, UsersIcon, SettingsIcon, PanelLeftOpenIcon, PanelLeftCloseIcon, MonitorIcon } from "lucide-react"; // Adicionado MonitorIcon
...
const navItems: NavItem[] = [
  ...
  { name: "ecranEstafeta", path: "/ecran-estafeta", icon: MonitorIcon, roles: ["restaurante", "admin"] }, // Novo item de navegação
